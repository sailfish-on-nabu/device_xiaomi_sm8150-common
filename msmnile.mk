...
PRODUCT_COPY_FILES += \
    ...
    $(LOCAL_PATH)/media/media_codecs_msmnile.xml:$(TARGET_COPY_OUT_VENDOR)/etc/media_codecs_msmnile.xml \
    ...
    $(LOCAL_PATH)/media/media_codecs_performance_msmnile.xml:$(TARGET_COPY_OUT_VENDOR)/etc/media_codecs_performance_msmnile.xml \
    ...
    $(LOCAL_PATH)/media/media_profiles_msmnile.xml:$(TARGET_COPY_OUT_VENDOR)/etc/media_profiles_msmnile.xml \
